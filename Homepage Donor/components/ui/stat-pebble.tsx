...
/**
 * Stat Pebble component
 *
 * Displays a key statistic with an icon
 */
const StatPebble = memo(function StatPebble({ icon, value, label, delay = 0 }: StatPebbleProps) {
  const icons = {
